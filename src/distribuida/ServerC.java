...
public class ServerC {
    private static final String DATA_FILE = "dados_servidor_c.json";
        ...
        try (ServerSocket serverSocket = new ServerSocket(9092)) {
            while (true) {
                try (Socket clientSocket = serverSocket.accept()) {
                    System.out.println("Servidor A conectado ao Servidor C");
                    ...
                    System.err.println("Erro na comunicação no Servidor C: " + e.getMessage());
                }
            }
        }
    }
